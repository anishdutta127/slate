...
export const metadata: Metadata = {
  ...
  description:
    "Why Slate exists. The story behind the actors' club of Mumbai.",
};
    ...
    <>
      ...
      >
        ...
        <div className="mx-auto mt-20 max-w-[720px] text-center md:mt-32">
          ...
          >
            For every fresher actor in Mumbai who has ever sent a Drive link to
            a casting director and watched the read receipt go cold.
          </p>
        ...
        >
          ...
          <p>
            ...
            e started by watching what actually happens between a fresher actor
            and a casting director on WhatsApp. The actor sends a Drive folder
            of videos, three Instagram reel links, and a screenshot of their
            stats. The casting director, scrolling through two hundred such
            messages a day, taps nothing. The actor refreshes for an hour.
            Then it&apos;s 11 PM, and tomorrow there&apos;s another audition.
          </p>

          <p className="mt-8">
            This is the part nobody told them in acting school. The job is
            half the craft, half the pitch. The pitch is happening on a
            messaging app with one chance to get tapped.
          </p>

          <BlockQuote>
            Slate is not a casting marketplace. It&apos;s the layer the actor
            controls — their presence, their pitch, their people.
          </BlockQuote>

          <p className="mt-8">
            [PLACEHOLDER — paragraph on what we&apos;re NOT. We&apos;re not Talentrack.
            We&apos;re not MCCC. We&apos;re not another &quot;AI will get you cast&quot;
            gimmick. We don&apos;t take a cut of jobs. Replace with your real
            framing of the &quot;not&quot; the user needs to hear.]
          </p>

          <p className="mt-8">
            [PLACEHOLDER — paragraph on what we ARE. A free, mobile-first
            profile builder + WhatsApp send kit + a real-world club. Open with
            the moment a fresher first sees their own film-poster profile —
            that&apos;s the emotional truth this paragraph should land.]
          </p>

          <SectionHeading>The club</SectionHeading>

          <p>
            [PLACEHOLDER — paragraph on the Sunday meetup in Aram Nagar. Why
            in-person matters. The vetting story. Who&apos;s welcome and who
            isn&apos;t. Founder voice; first person plural.]
          </p>

          <SectionHeading>What we won&apos;t do</SectionHeading>

          <p>
            [PLACEHOLDER — paragraph on the lines we won&apos;t cross. No paid
            tiers at launch. No pay-to-apply. No data sold to anyone, ever. No
            spammy casting-director-number directories. List the boundaries.]
          </p>

          <SectionHeading>What you can do</SectionHeading>

          <p>
            [PLACEHOLDER — closing call to action. Make a profile in 15
            minutes. Send your link to the next casting director. Come to
            Sunday in Aram Nagar. Don&apos;t wait for permission. Land on a
            specific, do-this-today action.]
          </p>
        </article>
      ...
      >
        <div className="mx-auto flex max-w-[1120px] flex-col items-center gap-4 text-center md:flex-row md:justify-between md:text-left">
          ...
          <nav className="flex flex-wrap items-center gap-6 font-mono text-[11px] uppercase tracking-[0.15em]">
            ...
            <Link href="/club" className="text-text-secondary hover:text-text-primary">Club</Link>
          </nav>
        </div>
      </Section>
    </>
